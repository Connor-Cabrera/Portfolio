...
public class PathogenOg
{
	...
	public static void enableAnimation() { PathogenOg.animationEnabled = true; }
	public static void disableAnimation() { PathogenOg.animationEnabled = false; }
	public static void setFrameRate(double fps) { PathogenOg.frameRate = frameRate; }
	                                 ...
	                                 int height, int width)
	{
		...
		if (PathogenOg.animationEnabled)
		{
			printAndWait(maze, height, width, "Searching...", PathogenOg.frameRate);
		}
		...
		if (visited[currentRow][currentCol] == 'e')
		{
			if (PathogenOg.animationEnabled)
			{
				...
				printAndWait(maze, height, width, "Hooray!", PathogenOg.frameRate);
			}
		}
	...
	public static void main(String [] args) throws IOException
	{
		...
		PathogenOg.enableAnimation();

		// Go!!
		if (PathogenOg.solveMaze(maze))
